...
import gg.gui.InvGui;

import gg.GgModElements;

@GgModElements.ModElement.Tag
public class REdstoneItem extends GgModElements.ModElement {
	@ObjectHolder("gg:r_edstone")
	public static final Item block = null;
	public REdstoneItem(GgModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(Timi1604ItemGroup.tab).maxStackSize(1));
			setRegistryName("r_edstone");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("is a item"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Redstone");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new InvGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	private static class InventoryCapability implements ICapabilitySerializable<CompoundNBT> {
		...
		private ItemStackHandler createItemHandler() {
			return new ItemStackHandler(73) {
				@Override
